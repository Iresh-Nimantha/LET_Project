                ...
                <form action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="title" id="title" class="block w-full rounded-xl border-gray-200 bg-gray-50 px-4 py-3 text-sm focus:bg-white focus:border-gold focus:ring-gold transition-colors" placeholder="e.g. 5 Trends in Modern Property Renovation" value="{{ old('title') }}" required>
                        ...
                        <div>
                            ...
                            <textarea name="excerpt" id="excerpt" rows="3" class="block w-full rounded-xl border-gray-200 bg-gray-50 px-4 py-3 text-sm focus:bg-white focus:border-gold focus:ring-gold transition-colors" placeholder="A short 1-2 sentence summary of the post..." required>{{ old('excerpt') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="content" id="content" rows="12" class="block w-full rounded-xl border-gray-200 bg-gray-50 px-4 py-3 text-sm focus:bg-white focus:border-gold focus:ring-gold transition-colors font-mono" placeholder="Write your full article here...">{{ old('content') }}</textarea>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-100 flex items-center justify-end gap-4">
                        ...
                        <button type="submit" class="inline-flex items-center justify-center rounded-xl bg-gray-900 px-6 py-3 text-sm font-bold text-white shadow-md hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 transition-colors">
                            <i class="fa-solid fa-check mr-2"></i> Publish Post
                        </button>
                    </div>
                </form>
            </div>
